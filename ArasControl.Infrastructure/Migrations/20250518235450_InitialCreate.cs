        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HarasId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AnimalOwnerId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    HarasOwnerId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HarasOwners", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dimensions_WeightKg = table.Column<double>(type: "float", nullable: false),
                    Dimensions_HeightCm = table.Column<double>(type: "float", nullable: false),
                    HarasId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OwnerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DateOfBirth = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Sex = table.Column<int>(type: "int", nullable: false),
                    MicrochipId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Animals_AnimalOwners_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AnimalOwners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Animals_Haras_HarasId",
                        column: x => x.HarasId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FeedInventories_Animals_AnimalId",
                        column: x => x.AnimalId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VitaminDoses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VitaminDoses_Animals_AnimalId",
                        column: x => x.AnimalId,
                        principalTable: "Animals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnimalOwners_HarasId",
                table: "AnimalOwners",
                column: "HarasId");

            migrationBuilder.CreateIndex(
                name: "IX_Animals_HarasId",
                table: "Animals",
                column: "HarasId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeedInventories_AnimalId",
